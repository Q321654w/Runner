...
using System.Linq;
using System.Text;
using Toony_Colors_Pro.Editor.Shader_Generator.ShaderGenerator.CodeInjection;
...
#pragma warning restore 414
			...
			internal void ClearShaderPropertiesFeatures()
			{
				...
				{
					Utils.Utilities.Utils.RemoveIfExists(this.Features, f);
				}
			}
			...
			internal void UpdateShaderProperties(Template template)
			{
				...
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2017_1");
#endif
#if UNITY_2018_1_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2018_1");
#endif
#if UNITY_2018_2_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2018_2");
#endif
#if UNITY_2018_3_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2018_3");
#endif
#if UNITY_2019_1_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2019_1");
#endif
#if UNITY_2019_2_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2019_2");
#endif
#if UNITY_2019_3_OR_NEWER
				Utils.Utilities.Utils.AddIfMissing(this.Features, "UNITY_2019_3");
#endif
			...
			internal bool ProcessKeywords(string line, List<string> tempFeatures, List<string> tempFlags, Dictionary<string, List<string>> tempExtraFlags)
			{
				...
				switch (parts[0])
				{
					...
					case "feature_on":
					{
						if (Utils.Utilities.Utils.AddIfMissing(tempFeatures, parts[1]))
						{
							return true;
						}
					...
					case "feature_off":
					{
						if (Utils.Utilities.Utils.RemoveIfExists(tempFeatures, parts[1]))
						{
							return true;
						}
					...
					case "flag_on":
						if (tempFlags != null)
						{
							if (Utils.Utilities.Utils.AddIfMissing(tempFlags, parts[1]))
							{
								return true;
							}
						}
					...
					case "flag_off":
						if (tempFlags != null)
						{
							if (Utils.Utilities.Utils.RemoveIfExists(tempFlags, parts[1]))
							{
								return true;
							}
						}
					...
					default:
					{
						...
						if (parts[0].StartsWith("flag_on:"))
						{
							...
							if (Utils.Utilities.Utils.AddIfMissing(tempExtraFlags[block], parts[1]))
							{
								return true;
							}
						}
						else if (parts[0].StartsWith("flag_off:"))
						{
							...
							if (Utils.Utilities.Utils.RemoveIfExists(tempExtraFlags[block], parts[1]))
							{
