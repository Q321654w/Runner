				...
				struct Option
				{
					...
					public void UpdateConfigIfNeeded(bool enabled)
					{
						if (this.affectConfig)
						{
							if (enabled)
							{
								Utils.Utilities.Utils.AddIfMissing(ShaderGenerator2.CurrentConfig.ExtraTempFeatures, this.feature);
							}
							else
							{
								Utils.Utilities.Utils.RemoveIfExists(ShaderGenerator2.CurrentConfig.ExtraTempFeatures, this.feature);
							}
						}
					}
				}
