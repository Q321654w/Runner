		...
		public partial class TCP2_ShaderGenerator : EditorWindow
		{
			...
			public class UIFeature_Mask : UIFeature
			{
				...
				protected override void DrawGUI(Rect position, TCP2_Config config)
				{
					...
					var curChannel = Utils.Utilities.Utils.FromShader(config.GetKeyword(channelKeyword));
					...
					curChannel = (Utils.Utilities.Utils.TextureChannel)EditorGUI.EnumPopup(middleRect, curChannel);
